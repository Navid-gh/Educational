export const Endpoints = {
  ...
  // landing endpoints
  getLanding: `/api/landing/getLanding`,
  addLanding: `/admin/landing/add`,
  editLanding: (id: string) => `/admin/landing/edit/${id}`,
  removeLanding: (id: string) => `/admin/landing/remove/${id}`,
