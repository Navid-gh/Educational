...
const LandingForm = ({ title }: { title: string }) => {
    ...
    return (
        <div className='flex flex-1 flex-col gap-4 items-center text-right bg-white p-10 rounded-2xl tips2:p-6 shadow-lg border-r-4 border-red-50'>
            ...
            <MainInput ref={nameRef} placeHolder='نام و نام خانوادگی' id='name' intent='login' inputSize='medium' />
            <MainInput ref={phoneRef} placeHolder='شماره همراه' id='phone' intent='login' inputSize='medium' />
