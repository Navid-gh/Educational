...
const BasketProducts = () => {
  ...
  const details = useMemo(() => {
    ...
    const initialDiscount = totalWithoutDiscount - totlaPrice;
    const codeDiscount = discountedPrice;
    const totalSavings = initialDiscount + codeDiscount;
    return [
      {
        key: 'تعداد محصولات',
      ...
      {
        key: 'سود شما',
        value: usePersianNums(totalSavings, true),
        id: uuidv4(),
      },
      {
